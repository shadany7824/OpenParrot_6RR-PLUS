		...
		*(DWORD *)(newCrc + pePTR + 54) = 0x00000000;
		...
		if (getenv("TP_DIRECTHOOK") == nullptr)
		{
			...
			if (*(uint32_t *)(moduleBase + 0x2F00) == 0x084AFF48)
			{
				...
				{
					SetGameId(GameID::WMMT6RRPlus, "WMMT5 Update 10-21");
				}
				break;
			}
		}
		...
		case 0x7E459AB3: // AMAuthd.exe (WMMT6RRPlus, timestamp 2022-11-29)
		...
		case 0xc20612d0: // Patched Base
			...
			break;
case 0xF80FBA83: // AMAuthd.exe (WMMT6RRPlus newCrc)
			SetGameId(GameID::AmAuthD64, "AMAuthd for WMMT");
			break;
#endif
		default:
